...
namespace API.Services
{
    public class UsuarioService
    {
        ...
        public readonly string _secretKey = "Passw0rdLuis_Eduardo_Criollo_130491";
        private readonly string _issuer = "pruebaTecnica";
        private readonly string _audience = "Logic Studio";
